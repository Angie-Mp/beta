...
import 'package:beta/main14.dart';
import 'package:beta/main4.dart';
import 'package:beta/main5.dart';
import 'package:flutter/material.dart';

// ignore: camel_case_types
class trece extends StatelessWidget {
  final Widget child;
  const trece({Key key, this.child}) : super(key: key); //termina
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => catorce()),
                        );
                      },
                      child: Container(
