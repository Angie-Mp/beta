...
class ocho extends StatelessWidget {
  final Widget child;
  const ocho({Key key, this.child}) : super(key: key); //termina
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => nueve()),
                        );
                      },
                      child: Container(
